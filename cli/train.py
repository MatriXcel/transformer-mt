...
from transformers import PreTrainedTokenizerFast, PretrainedBartModel
...
def main():
    ...
    source_tokenizer = PreTrainedTokenizerFast.from_pretrained(src_tokenizer_path)
    target_tokenizer = PreTrainedTokenizerFast.from_pretrained(tgt_tokenizer_path)
